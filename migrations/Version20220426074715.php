 ...
 */
final class Version20220426074715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE week ADD CONSTRAINT FK_5B5A69C030AA4BAD FOREIGN KEY (day_week_id) REFERENCES days (id)');
